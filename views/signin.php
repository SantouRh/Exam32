        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            ...
            <div class="form-group first">
                <label for="username"><a href="<?php echo site_url('welcome/index') ?>"><< Retour </a></label>
              </div>
            <form action="<?php echo base_url('user_controller/insertion')?>" enctype="multipart/form-data" method="get">
              <div class="form-group first">
                <label for="username">Email</label>
                <input type="text" class="form-control" placeholder="your-email@gmail.com" id="username" name="mail">
              </div>

              <div class="form-group first">
                <label for="username">Name</label>
                <input type="text" class="form-control" placeholder="Your Name" id="name" name="nom">
              </div>
              ...
              <!-- <button  class="btn btn-block btn-primary"><a href="#">Sign In</a></button> -->
            </form>
          </div>
        </div>
      </div>
